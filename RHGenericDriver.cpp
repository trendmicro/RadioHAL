...
RHGenericDriver::RHGenericDriver()
    ...
    _variablePayloadLen(true),
    _sizeOfPayloadLen(1),                 // usually one byte
    _thisAddress(RH_BROADCAST_ADDRESS),   // TODO remove this
    _txHeaderTo(RH_BROADCAST_ADDRESS),    // TODO remove this
    _txHeaderFrom(RH_BROADCAST_ADDRESS),  // TODO remove this
    _txHeaderId(0),                       // TODO remove this
    _txHeaderFlags(0),                    // TODO remove this
    _rxBad(0),
    _rxGood(0),
    _txGood(0),
    _cad_timeout(0),
...
{
  if (debug()) {
    _printer->print("[RHAL] Waiting for ");
...
void RHGenericDriver::setPrinter(Stream * printer)
{
  _printer = printer;
}

void RHGenericDriver::setDebug(bool enable)
{
...
{
  return _debugEnabled && _printer != nullptr;
}
