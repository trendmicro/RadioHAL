...
PROGMEM static const ModulationSchemes supportedModulationSchemes = {
...
PROGMEM static const RH_CC1120::ModemConfig MODEM_CONFIG_TABLE[] = {
    // 000A  000B  0011  0013  0014  0015  0016  2F01  2F0C  2F0D  2F0E
    {0x06, 0x03, 0x14, 0x05, 0x43, 0xA9, 0x2A, 0x22, 0x6C, 0x80,
     0x00}, // f868MHz_2_FSKd3_9Bw10_0Dr1_2_15dBm_WhitOff_ManchOff
    {0x06, 0x03, 0x08, 0x05, 0x43, 0xA9, 0x2A, 0x22, 0x6C, 0x80,
     0x00}, // f868MHz_2_FSKd3_9Bw25_0Dr1_2_15dBm_WhitOff_ManchOff
    {0x06, 0x03, 0x08, 0x05, 0x43, 0xA9, 0x2A, 0x22, 0x69, 0xA0,
     0x00}, // f169MHz_2_FSKd3_9Bw25_0Dr1_2_15dBm_WhitOff_ManchOff
    {0x26, 0x1D, 0x03, 0x04, 0x63, 0xA9, 0x2A, 0x00, 0x6C, 0x80,
     0x00}, // f868MHz_ASK_OOKd17_9Bw66_6Dr4_8_12_5dBm_WhitOff_ManchOff
    {0x53, 0x2F, 0x01, 0x05, 0xA9, 0x99, 0x99, 0x20, 0x76, 0xC0,
     0x00}, // f950MHz_4_GFSKd82_7Bw200_0Dr100_15dBm_WhitOff_ManchOff
    {0x06, 0x03, 0x14, 0x05, 0x43, 0xA9, 0x2A, 0x22, 0x6C, 0x80,
     0x00}, // f434MHz_2_FSKd3_9Bw10_0Dr1_2_15dBm_WhitOff_ManchOff
    {0x06, 0x03, 0x08, 0x05, 0x43, 0xA9, 0x2A, 0x22, 0x76, 0xC0,
     0x00}, // f950MHz_2_FSKd3_9Bw25_0Dr1_2_15dBm_WhitOff_ManchOff
    {0x48, 0x05, 0x04, 0x05, 0x43, 0xA9, 0x2A, 0x22, 0x6C, 0x80,
     0x00}, // f434MHz_2_FSKd20_0Bw50_0Dr1_2_15dBm_WhitOff_ManchOff
    {0x99, 0x0D, 0x02, 0x05, 0x99, 0x99, 0x99, 0x20, 0x76, 0xC0,
     0x00}, // f950MHz_2_GFSKd24_9Bw100_0Dr50_15dBm_WhitOff_ManchOff
    {0x06, 0x03, 0x08, 0x05, 0x43, 0xA9, 0x2A, 0x22, 0x6C, 0x80,
     0x00}, // f434MHz_2_FSKd3_9Bw25_0Dr1_2_15dBm_WhitOff_ManchOff
    {0x06, 0x03, 0x14, 0x05, 0x43, 0xA9, 0x2A, 0x22, 0x76, 0xC0,
     0x00}, // f950MHz_2_FSKd3_9Bw10_0Dr1_2_15dBm_WhitOff_ManchOff
    {0x53, 0x2F, 0x01, 0x05, 0xA9, 0x99, 0x99, 0x20, 0x6C, 0x80,
     0x00}, // f868MHz_4_GFSKd82_7Bw200_0Dr100_15dBm_WhitOff_ManchOff
    {0x99, 0x0D, 0x02, 0x05, 0x99, 0x99, 0x99, 0x20, 0x6C, 0x80,
     0x00}, // f434MHz_2_GFSKd24_9Bw100_0Dr50_15dBm_WhitOff_ManchOff
    {0x48, 0x05, 0x04, 0x05, 0x43, 0xA9, 0x2A, 0x22, 0x76, 0xC0,
     0x00}, // f950MHz_2_FSKd20_0Bw50_0Dr1_2_15dBm_WhitOff_ManchOff
    {0x48, 0x05, 0x04, 0x05, 0x43, 0xA9, 0x2A, 0x22, 0x6C, 0x80,
     0x00}, // f868MHz_2_FSKd20_0Bw50_0Dr1_2_15dBm_WhitOff_ManchOff
    {0x48, 0x05, 0x04, 0x05, 0x43, 0xA9, 0x2A, 0x22, 0x69, 0xA0,
     0x00}, // f169MHz_2_FSKd20_0Bw50_0Dr1_2_15dBm_WhitOff_ManchOff
    {0x48, 0x0D, 0x02, 0x05, 0x93, 0xA9, 0x2A, 0x22, 0x6C, 0x80,
     0x00}, // f868MHz_2_GFSKd20_0Bw100_0Dr38_4_15dBm_WhitOff_ManchOff
    {0x06, 0x03, 0x14, 0x05, 0x43, 0xA9, 0x2A, 0x22, 0x69, 0xA0,
     0x00}, // f169MHz_2_FSKd3_9Bw10_0Dr1_2_15dBm_WhitOff_ManchOff
    {0x99, 0x0D, 0x02, 0x05, 0x99, 0x99, 0x99, 0x20, 0x6C, 0x80,
     0x00} // f868MHz_2_GFSKd24_9Bw100_0Dr50_15dBm_WhitOff_ManchOff
};
...
PROGMEM static const uint8_t preambleValues[] = {0, 1, 2, 3,  4,  5,
                                                 6, 7, 8, 12, 24, 30};
...
RH_CC1120::RH_CC1120(uint8_t slaveSelectPin, uint8_t resetPin,
    ...
    : RHNRFSPIDriver(slaveSelectPin, spi), _deviceType(0x0000),
      _rxBufValid(false), _packetsToSend(0) {
...
void RH_CC1120::printRadioState() {
  ...
  if (debug()) {
    ...
    _printer->print("RH_CC1120_REG_2F94_MARC_STATUS1 = 0x");
...
#ifdef RHAL_DEBUG
  if (debug()) {
    printSupportedModulationSchemes();
  }
#endif
...
#ifdef RHAL_DEBUG
  if (debug())
    _printer->println("IRQ bus clear");
#endif
...
#ifdef RHAL_DEBUG
  if (debug()) {
    _printer->print("_variablePayloadLen = ");
...
void RH_CC1120::waitForMarcState(uint8_t state) {
  ...
  if (debug()) {
    _printer->println(
        "START MARCSTATE.MARC_STATE ==============================");
    _printer->print("[RHAL] Waiting for MARCSTATE.MARC_STATE == 0b");
    _printer->println(state, BIN);
  }
#endif

  while ((spiReadRegister(RH_CC1120_REG_2F73_MARCSTATE) &
          RH_CC1120_MARC_STATE_MASK) != state)
    YIELD;

#ifdef RHAL_DEBUG
  if (debug())
    _printer->println(
        "END MARCSTATE.MARC_STATE ==============================");
#endif
}
...
void RH_CC1120::updateRssi() {
  ...
  if (raw_rssi >= 128)
    ...
    _lastRssi = ((int16_t)raw_rssi /
                 2); // FIXME take care of calibration offset (see CC110L)
...
void RH_CC1120::handleInterrupt() {
  ...
  if (_mode == RHModeTx) {
    ...
    if (_marcStatus1 == RH_CC1120_MARC_STATUS1_TXDONE) {
      if (!_packetsToSend) {   // no packets left to send
        resetTxFifoPointers(); // reset the FIFO pointers
        setModeRx(); // go back in RX (TODO: it's OK for now, but should be
                     // configurable)
      } else {
        _packetsToSend--;
        spiWriteRegister(RH_CC1120_REG_2FD3_TXFIRST, 0x00); // reset the pointer
        setModeTx(); // and strobe STX again!
        // this behavior is described in Fig. 6 of the datasheet, page 16
      }
    ...
    if (_marcStatus1 == RH_CC1120_MARC_STATUS1_TXFIFO_OF ||
...
#ifdef RHAL_DEBUG
      if (debug())
        _printer->println("Flushing the TXFIFO because of an error");
#endif
      ...
      /* Flushing seems to bring the radio into an unexpected state (i.e.,
       * crash) */
      // spiCommand(RH_CC1120_STROBE_3B_SFTX); // flush will IDLE (TX won't be
      // re-tried) setModeRx();
      return;
    }
    /* TX ERR
  ...
  if (_mode == RHModeRx) {
    ...
    /* RXDONE
     * -------------------------------------------------------------------*/
    if (_bufLen > 0 && _bufLen <= RH_CC1120_MAX_PAYLOAD_LEN &&
        _marcStatus1 == RH_CC1120_MARC_STATUS1_RXDONE) {
...
#ifdef RHAL_DEBUG
      if (_bufLen)
        printBuffer("RX: ", _buf, _bufLen);
#endif

      validateRxBuf();

      // the radio will stay in RX
      setModeRx();
      return;
    }
    /* RXDONE
    ...
    if (_marcStatus1 == RH_CC1120_MARC_STATUS1_RXFIFO_OF ||
      ...
      if (debug())
        _printer->println(
            "Flushing the RXFIFO because of an over/underflow error");
#endif
...
#ifdef RHAL_DEBUG
      if (debug())
        _printer->println("Flushing the RXFIFO: got a bad packet");
#endif
    ...
    if (_marcStatus1 != RH_CC1120_MARC_STATUS1_RXDONE) {
      ...
      if (debug())
        _printer->println(
            "Flushing the RXFIFO because of an unexpected RX condition");
#endif
...
#ifdef RHAL_DEBUG
  if (debug())
    _printer->println("Unhandled IRQ");
#endif
}
...
void RH_CC1120::spiGenericRegAccess(uint8_t addr, uint8_t *data, uint16_t len) {
  ...
  if (debug()) {
    _printer->print("spiGenericRegAccess(addr = ");
...
#ifdef RHAL_SPI_DEBUG
  if (debug()) {
    _printer->print("shortRegAccess(accessType = ");
...
#ifdef RHAL_SPI_DEBUG
  if (debug()) {
    _printer->print("longRegAccess(accessType = ");
    _printer->print(accessType, HEX);
...
#ifdef RHAL_SPI_DEBUG
  if (debug()) {
    _printer->print("spiReadRegisterWrapper(reg = ");
...
#ifdef RHAL_SPI_DEBUG
  if (debug()) {
    _printer->print("spiReadRegister(reg = ");
    _printer->print(reg, HEX);
    _printer->print(") = ");
...
#ifdef RHAL_SPI_DEBUG
  if (debug()) {
    _printer->print("spiWriteRegister(reg = ");
    _printer->print(reg, HEX);
    _printer->print(", val = ");
...
void RH_CC1120::validateRxBuf() {
  // if variable payload len mode, we expect at least _sizeOfPayloadLen bytes
  // in the buffer, which encode(s) the length
  if (_variablePayloadLen) {
    if (_bufLen < _sizeOfPayloadLen)
      return; // there's no length byte

    // _bufLen >= _sizeOfPayloadLen
    // FIXME interpret as _sizeOfPayloadLen, not just 1 byte (the 0th)
    if (_buf[0] < 1)
      return; // length byte is there, but its value is < 1
  }
...
bool RH_CC1120::recv(uint8_t *buf, uint8_t *len) {
  ...
  if (buf && len) { // if not null
    ATOMIC_BLOCK_START;
    if (*len > _bufLen)
      *len = _bufLen;

    // if in variable payload mode, we skip `_sizeOfPayloadLen` bytes, which
    // hold the encoded length; we validate that, and copy whatever data follows

    // FIXME: instead of reading the len as 1 byte, read it as
    // `_sizeOfPayloadLen` bytes

    if (_variablePayloadLen && _buf[0] > 0 &&
        _buf[0] <= RH_CC1120_MAX_PAYLOAD_LEN - 1) {
      *len = _buf[0]; // set the length as the encoded length
      skip += _sizeOfPayloadLen;

#ifdef RHAL_DEBUG
      if (debug()) {
        _printer->print("The variable len encoded in the packet is ");
        _printer->println(_buf[0], DEC);
      }
#endif
    } else                              // fixed len mode
      *len = RH_CC1120_MAX_PAYLOAD_LEN; // TODO leave it up to the user?
...
void RH_CC1120::setPacketFormat(bool fixed, uint8_t len) {
  if (len > RH_CC1120_MAX_MESSAGE_LEN || len == 0)
    len = RH_CC1120_MAX_MESSAGE_LEN;
  else
    _fixedPayloadLen = len;

  _variablePayloadLen = !fixed;

  if (_variablePayloadLen)
    spiWriteRegister(RH_CC1120_REG_0028_PKT_CFG0,
                     0x20); // variable packet length
  else
    spiWriteRegister(RH_CC1120_REG_0028_PKT_CFG0,
                     0); // fixed packet length (0x00 = 256 bytes)
}
 ...
 */
void RH_CC1120::setPromiscuous(bool promiscuous) {
  if (_promiscuous == promiscuous)
    return;

  uint8_t synccfg = spiReadRegister(RH_CC1120_REG_0009_SYNC_CFG0);

  if (promiscuous)
    synccfg &= ~(0b111 << 2); // unset syncword detection
  else
    synccfg =
        (synccfg & ~(0b111 << 2)) |
        (0b101 << 2); // set syncword detection (to 4 bytes, we have no choice)

  spiWriteRegister(RH_CC1120_REG_0009_SYNC_CFG0, synccfg);

  _promiscuous = promiscuous;
}

bool RH_CC1120::send(const uint8_t *data, uint8_t len, uint32_t repeat) {
  // the interrupt handler will force TX mode while _packetsToSend > 0
  _packetsToSend = repeat;
...
#ifdef RHAL_DEBUG
    if (debug())
      _printer->println("[RHAL] Radio in RX mode");
#endif
    _mode = RHModeRx;
  }
}
...
void RH_CC1120::setPreambleLength(PreambleLen preambleLenIndex) {
  ...
  spiWriteRegister(RH_CC1120_REG_000D_PREAMBLE_CFG1 &
                       RH_CC1120_NUM_PREAMBLE_MASK,
...
void RH_CC1120::setDeviation(float deviation) {
}
...
bool RH_CC1120::setFrequency(float centre) {
  ...
  uint8_t fs_cfg = spiReadRegister(RH_CC1120_REG_0021_FS_CFG);
  fs_cfg = (fs_cfg & ~0b1111) | bandselect;
  spiWriteRegister(RH_CC1120_REG_0021_FS_CFG, fs_cfg);
...
void RH_CC1120::setDefaultRegisters() {
  ...
  spiWriteRegister(RH_CC1120_REG_0001_IOCFG2,
                   0x54); // connect GPO2 to MCU's interrupt pin
  ...
  // spiWriteRegister(RH_CC1120_REG_0023_WOR_CFG0, 0x22); // not sure if we want
  // to use WOR/eWOR
  spiWriteRegister(RH_CC1120_REG_0026_PKT_CFG2, 0x00);
  spiWriteRegister(
      RH_CC1120_REG_0027_PKT_CFG1,
      0x05); // check CRC in RX and add CRC in TX, but don't check address
  spiWriteRegister(RH_CC1120_REG_0029_RFEND_CFG1,
                   0x1F); // go in SFSTXON after each RX'd packet (STX o SRX
                          // will quickly go to TX/RX state respectively)
  spiWriteRegister(RH_CC1120_REG_002A_RFEND_CFG0,
                   0x18); // go in SFSTXON after each TX'd packet (STX o SRX
                          // will quickly go to TX/RX state respectively)
  ...
  spiWriteRegister(RH_CC1120_REG_002E_PKT_LEN,
                   0xFF); // max = 256 bytes enforced by the CC1120
}
...
void RH_CC1120::setSyncWords(const uint8_t *syncWords, uint8_t len) {
  // disable syncwords detection
  if (!len || !syncWords || !*(syncWords)) {
    spiWriteRegister(RH_CC1120_REG_0009_SYNC_CFG0, 0x00);
    return;
  }
  ...
  if (len <= 4) {
    ...
    if (len == 2)
      synccfg = (synccfg & ~(0b111 << 2)) | (0b010 << 2);

    if (len == 4)
      synccfg = (synccfg & ~(0b111 << 2)) | (0b100 << 2);

    if (len == 8)
      synccfg = (synccfg & ~(0b111 << 2)) | (0b101 << 2);
