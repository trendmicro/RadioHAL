...
void RHHardwareSPI::begin() {
  ...
  if (_frequency == Frequency16MHz)
    ...
    defined(ARDUINO_ARCH_NRF52) || defined(ARDUINO_ARCH_STM32F1) ||            \
  ...
  case Frequency16MHz:
    divider =
        SPI_CLOCK_DIV2; // Not really 16MHz, only 8MHz. 4MHz on an 8MHz Arduino
    break;
  }
  ...
  // to be in Arduino Board Manager ESP8266 Community version 2.1.0 Contributed
  // by David Skinner begin comes first
  SPI.begin();
